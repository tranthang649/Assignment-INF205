                    ...
                    <div class="contentmanage">
                       <h3><strong>Products</strong></h3>
                        <asp:FormView ID="FormView1" runat="server" DataKeyNames="Product_ID" DataSourceID="SqlDataSource1">
                         ...
                         <h3><strong>Products</strong></h3>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Product_ID" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%">
                            <Columns>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ManageConnectionString %>" DeleteCommand="DELETE FROM [Products] WHERE [Product_ID] = @Product_ID" InsertCommand="INSERT INTO [Products] ([Product_ID], [Product_Category_ID], [Product_Name], [Price], [Description]) VALUES (@Product_ID, @Product_Category_ID, @Product_Name, @Price, @Description)" SelectCommand="SELECT * FROM [Products]" UpdateCommand="UPDATE [Products] SET [Product_Category_ID] = @Product_Category_ID, [Product_Name] = @Product_Name, [Price] = @Price, [Description] = @Description WHERE [Product_ID] = @Product_ID">
                            <DeleteParameters>
