                ...
                <div class="row">
                    ...
                    <div class="contentmanage">
                       <h3><strong>Oder</strong></h3>
                        <asp:FormView ID="FormView1" runat="server" DataKeyNames="Purchase_ID" DataSourceID="SqlDataSource1">
                            <EditItemTemplate>
                                Purchase_ID:
                        ...
                        <h3><strong>Oder</strong></h3>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Purchase_ID" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%">
                            <Columns>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ManageConnectionString %>" DeleteCommand="DELETE FROM [Purchase] WHERE [Purchase_ID] = @Purchase_ID" InsertCommand="INSERT INTO [Purchase] ([Purchase_ID], [Date], [Customer_ID]) VALUES (@Purchase_ID, @Date, @Customer_ID)" SelectCommand="SELECT * FROM [Purchase]" UpdateCommand="UPDATE [Purchase] SET [Date] = @Date, [Customer_ID] = @Customer_ID WHERE [Purchase_ID] = @Purchase_ID">
                            <DeleteParameters>
